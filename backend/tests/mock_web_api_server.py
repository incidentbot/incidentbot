...
# https://github.com/slackapi/bolt-python/blob/v1.6.1/tests/mock_web_api_server.py
# https://github.com/slackapi/bolt-python/issues/380
...
class MonitorThread(threading.Thread):
    def __init__(
        self,
        test: TestCase,
        handler: Type[SimpleHTTPRequestHandler] = MockHandler,
    ):
